...
begin
  ...
  if qtdVencendo > 0 then
   begin
     ...
     labelNotification.Caption := 'Há '+ IntToStr(qtdVencendo) +' despesa(s) a pagar ';
   end;
end;
         ...
         on E : exception do
           begin
             ...
             MessageDlg('Erro ao tentar se conectar com o banco de dados.'+#13
                        ...
                        +#13+'Notificação técnica do erro:'+#13+#13+''+auxError,TMsgDlgType.mtWarning,[TMsgDlgBtn.mbOK],0);
