    ...
    try
      ...
      begin
        ...
        begin
          ...
          DescricaoConcatenada := DescricaoConcatenada + ' - ' + VarToStr(Planilha.Cells[Linha, 2]);//'texto avulso'; //+ ' - ' + Planilha.Cells[Linha, 2];
...
begin
  ...
  lblQuantidade.Caption := lblQuantidade.Caption + IntToStr(cldsPlanilhaLote.RecordCount);
end;
